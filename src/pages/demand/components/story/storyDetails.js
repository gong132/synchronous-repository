...
import {DatePicker, Descriptions, Form, Input, message, Popconfirm, Select} from "antd";
...
const Index = withRouter(props => {
  ...
  const [description, setDescription] = useState(storyDetails?.description || "")
          ...
          <Descriptions.Item span={1} label="IT预计上线时间">
            <FormItem>
              {form.getFieldDecorator('evaluateTime', {
                rules: [{ required: true, message: '请选择IT预计上线时间' }],
          ...
          <Descriptions.Item span={1} label="开发预计工作量(人天)">
            <FormItem>
              {form.getFieldDecorator('developWorkload', {
                rules: [{ required: true, message: '请输入开发预计工作量' }],
          ...
          <Descriptions.Item span={2} label="测试预计工作量(人天)">
            <FormItem>
              {form.getFieldDecorator('testWorkload', {
                rules: [{ required: true, message: '请输入测试预计工作量' }],
